...
read_type_flag = IV_READY;
        ...
        case IV_READY: {
            ...
            rsp->attr_value.len = 22; //Adjusted from 16 to 22
            memcpy(rsp->attr_value.value, data_buf, 22); //Adjusted from 16 to 22
        ...
        case DATA_READY: {        
            ...
            rsp->attr_value.value[20] = data.oxygen1 & 0xff;
            rsp->attr_value.value[21] = (data.oxygen1 >> 8);
