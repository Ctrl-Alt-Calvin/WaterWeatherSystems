  ...
  List<Map<String, dynamic>> formatData(List<BuoyData> data) {
    ...
    for (int i = 0; i < data.length; i++) {
      ...
      var jsonData = {
        ...
        "depthSalinity": data[i].salinity2.toDouble(),
                    ...
                    child: ConstrainedBox(
                      ...
                      child: DataTable(
                        columns: [
                          ...
                          DataColumn(label: Text('Oxygen', style: GoogleFonts.lato(fontSize: 14, fontWeight: FontWeight.bold),)),
                          ...
                          data.length,
                            ...
                            return DataRow(
                              ...
                              cells: [
                                ...
                                DataCell(Text('${currentData.oxygen} %', style: GoogleFonts.lato(fontSize: 14, fontWeight: FontWeight.w500))),
