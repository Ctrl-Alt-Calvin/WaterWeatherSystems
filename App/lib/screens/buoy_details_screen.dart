...
class BuoyDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var dataPoints = [
      BuoyData(300, 20, 26, 32, 25, 31, 110, 45, 38, 13),
      BuoyData(600, 19, 24, 31, 24, 30, 105, 47, 40, 13),
      BuoyData(900, 21, 25, 29, 26, 32, 102, 43, 36, 13),
      BuoyData(1200, 18, 23, 30, 23, 29, 100, 46, 39, 13),
      BuoyData(1500, 22, 27, 33, 27, 33, 108, 44, 37, 13),
      BuoyData(1800, 19, 26, 32, 25, 31, 109, 42, 35, 13),
      BuoyData(2100, 20, 24, 31, 24, 30, 107, 48, 41, 13),
      BuoyData(2400, 21, 25, 30, 26, 32, 101, 45, 38, 13),
      BuoyData(2700, 18, 23, 30, 23, 29, 106, 47, 40, 13),
      BuoyData(3000, 22, 27, 33, 27, 33, 103, 43, 36, 13),
      BuoyData(3300, 19, 26, 32, 25, 31, 104, 46, 39, 13),
      BuoyData(3600, 20, 24, 31, 24, 30, 111, 44, 37, 13),
      BuoyData(3900, 21, 25, 29, 26, 32, 107, 42, 35, 13),
      BuoyData(4200, 18, 23, 30, 23, 29, 102, 48, 41, 13),
      BuoyData(4500, 22, 27, 33, 27, 33, 105, 45, 38, 13),
    ];
